...
use BrjupoEavAttributesOldWorkaround\CustomerAddress\Options\DropdownOptions;


class DropdownAttributeUsingSourceTwo implements DataPatchInterface, PatchRevertableInterface
{
    const ATTRIBUTE_CODE = 'd1738';
